...
class GoToPoseClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('x_goal_value', 3.0)
        self.declare_parameter('y_goal_value', 5.0)
    ...
    def send_goal(self):
        ...
        # get user-specified goal from param file
        x = self.get_parameter('x_goal_value').value
        y = self.get_parameter('y_goal_value').value
        #x, y = self.x_goal, self.y_goal
